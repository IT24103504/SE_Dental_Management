...
// Enhanced emergency request creation
async function createEmergencyRequest() {
    ...
    try {
        const requiredFields = ['patientName', 'type'];
        const formData = new FormData();
        ...
        ErrorHandler.validateForm(formData, requiredFields);
        ...
        // This now works with plain text responses
        await ApiService.createEmergencyRequest(formData);
